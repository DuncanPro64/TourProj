...
<main>
  ...
  <div class="container-fluid">
    ...
    <h3 class="text-center"> Delete subcategory </h3>
    <div>
        ...
        <div class="form-row align-items-center">
          <div class="col-auto my-1">
            ...
            <select class="custom-select mr-sm-2" id="" name="username">
              ...
              <option value="3">Iterate through subcategories setting userId as value and Username as the display name</option>
            </select>
          </div>
          <div class="col-auto my-1">
