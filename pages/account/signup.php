        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user">
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="" placeholder="First Name">
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" id="" placeholder="Last Name">
                  </div>
                </div>
                <div class="form-group">
              ...
              <hr>
              <!-- <div class="text-center">
                <a class="small" href="./pages/account/forgotpassword.php">Forgot Password?</a>
              </div> -->
              <div class="text-center">
                <a class="small" href="./pages/account/login.php">Already have an account? Login!</a>
              </div>
            </div>
          </div>
        </div>
